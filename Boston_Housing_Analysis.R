...
model.housing.basic<-lm(log_home_median_val_1000s~1,data=boston_housing_data) # Null model
model.housing.full<-lm(log_home_median_val_1000s~.,data=boston_housing_data) # Full model
...
outliers_boston_model4 <- lm(log_home_median_val_1000s ~ pct_lower_status_pop 
